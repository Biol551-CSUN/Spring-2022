...
This is temperature and salinity data taken at a site with groundwater while being dragged behind a float. Data were collected every 10 seconds. You will also notice depth data.  That dataset will be used in late during lab. Those data are taken from a pressure sensor, also collected data every 10 seconds. 
