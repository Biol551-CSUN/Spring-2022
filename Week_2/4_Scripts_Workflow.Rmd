...
1.  Before class starts, navigate to "Spring-2022" in your projects (upper right-hand corner of RStudio) and **pull.**
...
- Create a folder titled "Week_2" and 3 subfolders titled "Scripts", "Data", and "Output"
...
- Copy the **"weightdata.csv"** file from the Spring-2022 repo into your own private repo.  Put it in the **data** folder within **Week_2**.  

--

- Open a new script and save it in your **scripts** folder within **Week_2**. You can name it whatever you want. 
